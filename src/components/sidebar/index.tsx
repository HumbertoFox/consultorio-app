    ...
    return (
        <div className={`${styles.divsidebar} ${styles['no-print']}`}>
            ...
            <nav className={styles.navsidebar}>
                <button title='Agenda de Pacientes Confirmados' type='button' className={pathname === '/' ? styles.active : ''}>
                    <Link href={'/'}>
                ...
                <button type='button' title='Agendar Consulta para Doutora' className={pathname === '/consultations/doctorx' ? styles.active : ''}>
                ...
                <button type='button' title='Lista de Pacientes do Dia Doutora' className={pathname === '/consultations/reportx' ? styles.active : ''}>
                ...
                <button type='button' title='Agendar Consulta para Doutor' className={pathname === '/consultations/doctory' ? styles.active : ''}>
                ...
                <button type='button' title='Lista de Pacientes do Dia Doutor' className={pathname === '/consultations/reporty' ? styles.active : ''}>
                ...
                <button type='button' title='Sair do Sistema' className={styles.exitbutton}>
                    <Link href={'/logout'}>
                        <Icon className={styles.iconexit} icon={'fa-solid fa-right-from-bracket'} />
